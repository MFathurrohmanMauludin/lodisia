...
const NavigationBottom = () => {
    ...
    return (
        <>
            <div className="w-full hidden sm:sticky md:sticky md:bottom-0 sm:bottom-0 sm:block md:block z-50 py-3 px-4 rounded-t-xl bg-white/60 backdrop-blur-sm border-t-1 bottom-0">
